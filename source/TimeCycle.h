...
public:
	...
	static void CalcColoursForPoint(float x, float y, float z, CColourSet2* colorset);
	static void StartExtraColour(int extracolor, int keepInter);
	static void FindTimeCycleBox(float x, float y, float z, CTimeCycleBox2** box, float* interp, bool checkLod, bool checkFar, CTimeCycleBox2* exclude);
