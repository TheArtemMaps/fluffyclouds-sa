...
uchar CTimeCycle2::m_nDirectionalMult[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nWaterFogAlpha[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nHighLightMinIntensity[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_fCloudAlpha[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_fPostFx2Alpha[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_fPostFx2Blue[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_fPostFx2Green[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_fPostFx2Red[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_fPostFx1Alpha[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_fPostFx1Blue[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_fPostFx1Green[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_fPostFx1Red[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_fWaterAlpha[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_fWaterBlue[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_fWaterGreen[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_fWaterRed[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nFluffyCloudsBottomRed[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nFluffyCloudsBottomGreen[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nFluffyCloudsBottomBlue[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nLowCloudsBlue[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nLowCloudsGreen[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nLowCloudsRed[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_fLightsOnGroundBrightness[NUMHOURS][NUMWEATHERS];
short CTimeCycle2::m_fFogStart[NUMHOURS][NUMWEATHERS];
int32 CTimeCycle2::m_nCurrentFluffyCloudsTopRed;
int32 CTimeCycle2::m_nCurrentFluffyCloudsTopGreen;
int32 CTimeCycle2::m_nCurrentFluffyCloudsTopBlue;
short CTimeCycle2::m_fFarClip[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nPoleShadowStrength[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nLightShadowStrength[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nShadowStrength[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_fSpriteBrightness[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_fSpriteSize[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_fSunSize[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nSunCoronaBlue[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nSunCoronaGreen[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nSunCoronaRed[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nSunCoreBlue[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nSunCoreGreen[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nSunCoreRed[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nSkyBottomBlue[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nSkyBottomGreen[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nSkyBottomRed[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nSkyTopBlue[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nSkyTopGreen[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nSkyTopRed[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nAmbientBlue_Obj[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nAmbientGreen_Obj[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nAmbientRed_Obj[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nAmbientBlue[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nAmbientGreen[NUMHOURS][NUMWEATHERS];
uchar CTimeCycle2::m_nAmbientRed[NUMHOURS][NUMWEATHERS];
uint8 CTimeCycle2::m_nFluffyCloudsTopRed[NUMHOURS][NUMWEATHERS];
uint8 CTimeCycle2::m_nFluffyCloudsTopGreen[NUMHOURS][NUMWEATHERS];
uint8 CTimeCycle2::m_nFluffyCloudsTopBlue[NUMHOURS][NUMWEATHERS];

float& CTimeCycle2::m_BrightnessAddedToAmbientRed = *(float*)0xB79E38;
float& CTimeCycle2::m_BrightnessAddedToAmbientGreen = *(float*)0xB79E34;
float& CTimeCycle2::m_BrightnessAddedToAmbientBlue = *(float*)0xB79E30;

int& CTimeCycle2::m_ExtraColourWeatherType = *(int*)0xB79E40;
int& CTimeCycle2::m_ExtraColour = *(int*)0xB79E44;
int& CTimeCycle2::m_bExtraColourOn = *(int*)0xB7C484;
float& CTimeCycle2::m_ExtraColourInter = *(float*)0xB79E3C;
CVector& CTimeCycle2::m_vecDirnLightToSun = *(CVector*)0xB7CB14;
int& CTimeCycle2::m_FogReduction = *(int*)0xB79E48;
CVector* CTimeCycle2::m_VectorToSun = (CVector*)0xB7CA50;
float* CTimeCycle2::m_fShadowFrontX = (float*)0xB79F90;
float* CTimeCycle2::m_fShadowFrontY = (float*)0xB79F50;
float* CTimeCycle2::m_fShadowSideX = (float*)0xB79F10;
float* CTimeCycle2::m_fShadowSideY = (float*)0xB79ED0;
float* CTimeCycle2::m_fShadowDisplacementX = (float*)0xB79E90;
float* CTimeCycle2::m_fShadowDisplacementY = (float*)0xB79E50;
int& CTimeCycle2::m_CurrentStoredValue = *(int*)0xB79FD0;
RwRGBA& CTimeCycle2::m_BelowHorizonGrey = *(RwRGBA*)0xB7CB10;
#ifdef REPLACE
CColourSet2 CTimeCycle2::m_CurrentColours;
CColourSet2& CTimeCycle2::m_CurrentColours_exe = *(CColourSet2*)0xB7C4A0;
#else
CColourSet2& CTimeCycle2::m_CurrentColours = *(CColourSet2*)0xB7C4A0;
#endif


void
CTimeCycle2::StartExtraColour(int extracolor, int keepInter)
{
	CTimeCycle2::m_ExtraColourWeatherType = extracolor / NUMHOURS + EXTRASTART;
	CTimeCycle2::m_ExtraColour = extracolor % NUMHOURS;
	CTimeCycle2::m_bExtraColourOn = 1;
	CTimeCycle2::m_ExtraColourInter = 0.0f;
	if (!keepInter)
		CTimeCycle2::m_ExtraColourInter = 1.0f;
}

void
CTimeCycle2::Initialise(bool unused)
{
	int fd;
	int w, h;
	char* line;
...
WRAPPER void CTimeCycle2::FindTimeCycleBox(float x, float y, float z, CTimeCycleBox2** box, float* interp, bool checkLod, bool checkFar, CTimeCycleBox2* exclude)
{
...
void
CTimeCycle2::CalcColoursForPoint(float x, float y, float z, CColourSet2* colorset)
{
	CTimeCycleBox2* lodBox, * farBox1, * farBox2, * weatherBox, * tmpBox;
	...
	if (farBox1) {
		CTimeCycle2::FindTimeCycleBox(x, y, z, &farBox2, &farBox2Interp, false, true, farBox1);
		if (farBox2)
	...
	CColourSet2 curold(curHourSel, CWeather::OldWeatherType);
	CColourSet2 nextold(nextHourSel, CWeather::OldWeatherType);
	CColourSet2 curnew(curHourSel, CWeather::NewWeatherType);
	CColourSet2 nextnew(nextHourSel, CWeather::NewWeatherType);

	if (*(CMatrix**)(0xB6F028 + 0x14))	// TheCamera coords
		camZ = (*(sus**)(0xB6F028 + 0x14))->sus2.pos.z;
	else
	...
	if (CWeather::OldWeatherType == EXTRASUNNY_SMOG_LA) {
		CColourSet2 set1(curHourSel, EXTRASUNNY_LA);
		curold.Interpolate(&curold, &set1, 1.0 - f, f, false);
		CColourSet2 set2(nextHourSel, EXTRASUNNY_LA);
		nextold.Interpolate(&nextold, &set2, 1.0 - f, f, false);
	}
	else if (CWeather::OldWeatherType == SUNNY_SMOG_LA) {
		CColourSet2 set1(curHourSel, SUNNY_LA);
		curold.Interpolate(&curold, &set1, 1.0 - f, f, false);
		CColourSet2 set2(nextHourSel, SUNNY_LA);
		nextold.Interpolate(&nextold, &set2, 1.0 - f, f, false);
	}
	...
	CColourSet2 oldInterp, newInterp;
	...
	if (m_ExtraColourInter > 0.0f) {
		CColourSet2 extraset(m_ExtraColour, m_ExtraColourWeatherType);
	...
	if (CWeather::UnderWaterness > 0.0f) {
		CColourSet2 curuwset(curHourSel, 20);
		CColourSet2 nextuwset(nextHourSel, 20);
		CColourSet2 tmpset;
	...
	if (CWeather::InTunnelness > 0.0f) {
		CColourSet2 tunnelset(tunnelWeather % NUMHOURS, tunnelWeather / NUMHOURS + EXTRASTART);
	...
	if (((sus*)(0xB6F028 + 0x974))->sus2.up.z < -0.9
...
double
CTimeCycle2::FindFarClipForCoors(float x, float y, float z)
{
	CColourSet2 s;
	bool extraOn;
	float extraInter;
	extraOn = CTimeCycle2::m_bExtraColourOn != 0;
	extraInter = CTimeCycle2::m_ExtraColourInter;
	CTimeCycle2::m_bExtraColourOn = 0;
	CTimeCycle2::m_ExtraColourInter = 0.0;
	CTimeCycle2::CalcColoursForPoint(x, y, z, &s);
	CTimeCycle2::m_bExtraColourOn = extraOn;
	CTimeCycle2::m_ExtraColourInter = extraInter;
	return s.farclp;
}
...
CTimeCycle2::Update(void)
{
	RwV3d* pos;
	if (*(CMatrix**)(0xB6F028 + 0x14))	// TheCamera coords
		pos = &(*(sus**)(0xB6F028 + 0x14))->sus2.pos;
	else
